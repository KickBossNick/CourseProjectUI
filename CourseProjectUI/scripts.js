...
const connection = new signalR.HubConnectionBuilder()
    .withUrl("https://localhost:7209/api/Indicator")
...
function getIndicators(){
    axios.get('https://localhost:7209/api/Indicator')
    .then(result =>{
        console.log(result);
...
function tryNewIndicator(name, value, unit, x, y)
{
    ...
    axios.post('https://localhost:7209/api/Indicator', {
...
function changeBackgroundImage(id)
{
    ...
    element.src = 'https://localhost:7209/api/BackgroundImage/' + id;
    console.log(element)
}
...
document.getElementById("imageForm").addEventListener("submit", function(event){
    ...
    if(fileInput)
    {
        ...
        axios.post('https://localhost:7209//api/backgroundimage/upload-image', formData)
        .then(result =>{
...
function onDelete(e, id){
    axios.delete(`https://localhost:7209/api/Indicator/${id}`);
